    ...
    return Scaffold(
      body: Center(
        child: Row(
          ...
          children: const [
            StarterIcon(svgAsset: 'assets/images/svgIcons/football-svg.svg',newRouteName: FootballHomeScreen.routeName, ),
           StarterIcon(svgAsset: 'assets/images/svgIcons/basketball-svg.svg', newRouteName: BasketHomeScreen.routeName)
          ],
        ),
      ),
    );
...
class StarterIcon extends StatelessWidget {
  const StarterIcon({
    Key? key,  required this.svgAsset,required this.newRouteName,
  }) : super(key: key);
